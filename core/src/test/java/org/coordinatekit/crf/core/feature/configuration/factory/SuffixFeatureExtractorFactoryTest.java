...
/**
 * Tests the {@code suffix} factory renders {@code NAME=<suffix>} for the trailing characters.
 *
 * <p>
 * This is an intentional behavioral mirror of {@link PrefixFeatureExtractorFactoryTest}; keep the
 * two symmetric.
 */
class SuffixFeatureExtractorFactoryTest {
    @Test
    void create__lengthBelowMinimumThrowsLocatedException() {
        // ARRANGE //
        FeatureExtractorNode node = FeatureExtractorNodes.builder("suffix").parameter("length", "0").build();
