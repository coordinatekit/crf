...
class PatternFeatureExtractorFactoryTest {
    ...
    void create__invalidRegexThrowsLocatedException() {
        // ARRANGE //
        FeatureExtractorNode node = FeatureExtractorNodes.builder("pattern")
                .parameter("regex", "[0-9")
                .parameter("name", "IS_NUMBER")
                .build();
    ...
    static Stream<CreateRenderParameters> create__render() {
        return Stream.of(
                new CreateRenderParameters(
                        "match_emits_name",
                        FeatureExtractorNodes.builder("pattern")
                                .parameter("regex", "[0-9]+")
                                .parameter("name", "IS_NUMBER")
                                .parameter("notMatchedName", "NOT_NUMBER")
                                .build(),
                        List.of("42"),
                        0,
                        Set.of("IS_NUMBER")
