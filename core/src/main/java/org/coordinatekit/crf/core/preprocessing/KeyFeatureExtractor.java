 ...
 * inflation a {@link org.coordinatekit.crf.core.preprocessing.WindowFeatureExtractor} adds. It is
 * easier to read at a glance, which is why it backs the key view. When none is registered the key
 * view falls back to the {@link FullFeatureExtractor}.
 *
 * <p>
 ...
 */
@NullMarked
public interface KeyFeatureExtractor<F> extends FeatureExtractor<F> {}
